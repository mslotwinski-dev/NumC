...
numc::func<T> exp(const numc::func<T>& f) {
  return numc::func<T>([f](const vector<T>& x) { return std::exp(f(x)); });
}
...
numc::func<T> ln(const numc::func<T>& f) {
  return numc::func<T>([f](const vector<T>& x) { return std::log(f(x)); });
}
...
numc::func<T> log2(const numc::func<T>& f) {
  return numc::func<T>([f](const vector<T>& x) { return std::log2(f(x)); });
}
...
numc::func<T> log10(const numc::func<T>& f) {
  return numc::func<T>([f](const vector<T>& x) { return std::log10(f(x)); });
}
...
numc::func<T> log(T base, const numc::func<T>& f) {
  return numc::func<T>([base, f](const vector<T>& x) { return std::log(f(x)) / std::log(base); });
}
...
numc::func<T> sin(const numc::func<T>& f) {
  return numc::func<T>([f](const vector<T>& x) { return std::sin(f(x)); });
}
...
numc::func<T> cos(const numc::func<T>& f) {
  return numc::func<T>([f](const vector<T>& x) { return std::cos(f(x)); });
}
...
numc::func<T> tan(const numc::func<T>& f) {
  return numc::func<T>([f](const vector<T>& x) { return std::tan(f(x)); });
}
...
numc::func<T> cot(const numc::func<T>& f) {
  return numc::func<T>([f](const vector<T>& x) { return T(1.0) / std::tan(f(x)); });
}
...
numc::func<T> asin(const numc::func<T>& f) {
  return numc::func<T>([f](const vector<T>& x) { return std::asin(f(x)); });
}
...
numc::func<T> acos(const numc::func<T>& f) {
  return numc::func<T>([f](const vector<T>& x) { return std::acos(f(x)); });
}
...
numc::func<T> atan(const numc::func<T>& f) {
  return numc::func<T>([f](const vector<T>& x) { return std::atan(f(x)); });
}
...
numc::func<T> acot(const numc::func<T>& f) {
  return numc::func<T>([f](const vector<T>& x) { return std::atan2(T(1.0), f(x)); });
}
...
numc::func<T> sinh(const numc::func<T>& f) {
  return numc::func<T>([f](const vector<T>& x) { return std::sinh(f(x)); });
}
...
numc::func<T> cosh(const numc::func<T>& f) {
  return numc::func<T>([f](const vector<T>& x) { return std::cosh(f(x)); });
}
...
numc::func<T> tanh(const numc::func<T>& f) {
  return numc::func<T>([f](const vector<T>& x) { return std::tanh(f(x)); });
}
...
numc::func<T> coth(const numc::func<T>& f) {
  return numc::func<T>([f](const vector<T>& x) { return T(1.0) / std::tanh(f(x)); });
}
...
numc::func<T> asinh(const numc::func<T>& f) {
  return numc::func<T>([f](const vector<T>& x) { return std::asinh(f(x)); });
}
...
numc::func<T> acosh(const numc::func<T>& f) {
  return numc::func<T>([f](const vector<T>& x) { return std::acosh(f(x)); });
}
...
numc::func<T> atanh(const numc::func<T>& f) {
  return numc::func<T>([f](const vector<T>& x) { return std::atanh(f(x)); });
}
...
numc::func<T> acoth(const numc::func<T>& f) {
  return numc::func<T>([f](const vector<T>& x) { return std::atanh(T(1.0) / f(x)); });
}
...
numc::func<T> sqrt(const numc::func<T>& f) {
  return numc::func<T>([f](const vector<T>& x) { return std::sqrt(f(x)); });
}
...
numc::func<T> cbrt(const numc::func<T>& f) {
  return numc::func<T>([f](const vector<T>& x) { return std::cbrt(f(x)); });
}
...
numc::func<T> root(T degree, const numc::func<T>& f) {
  return numc::func<T>([degree, f](const vector<T>& x) { return std::pow(f(x), T(1.0) / degree); });
}
...
numc::func<T> abs(const numc::func<T>& f) {
  return numc::func<T>([f](const vector<T>& x) { return std::abs(f(x)); });
}
...
numc::func<T> sign(const numc::func<T>& f) {
  return numc::func<T>([f](const vector<T>& x) {
    T val = f(x);
...
numc::func<T> floor(const numc::func<T>& f) {
  return numc::func<T>([f](const vector<T>& x) { return std::floor(f(x)); });
}
...
numc::func<T> ceil(const numc::func<T>& f) {
  return numc::func<T>([f](const vector<T>& x) { return std::ceil(f(x)); });
}
...
numc::func<T> round(const numc::func<T>& f, int places = 0) {
  return numc::func<T>([f, places](const vector<T>& x) {
